...
$photo_src  = '../' . ($user_photo ?: 'assets/img/default-avatar.png');

include __DIR__ . '/../includes/header.php';
?>

<main class="flex flex-col items-center justify-center min-h-screen w-screen bg-gray-50 overflow-auto">
  <div class="bg-white shadow-xl p-6 w-full max-w-3xl m-4">
    <h1 class="text-2xl font-bold mb-12 text-center">Edit Profile</h1>
    ...
    <div class="flex flex-col md:flex-row gap-6">
      ...
      <div class="flex-1 flex flex-col items-center">
        <div class="relative w-36 h-36">
          <img id="photoPreview" src="<?= htmlspecialchars($photo_src) ?>"
               class="w-36 h-36 object-cover rounded-full border-4 border-gray-200 shadow-sm">

          <!-- change button -->
          <button id="changePhotoBtn"
                  type="button"
                  class="absolute bottom-0 right-0 bg-black text-white text-xs px-3 py-1 rounded-full hover:bg-gray-800 transition z-50 pointer-events-auto">
            Change
          </button>
          ...
          <button id="removePhotoBtn"
                  type="button"
                  title="Remove photo"
                  class="absolute top-0 right-0 bg-white text-red-600 text-xs px-2 py-1 rounded-full border z-50 pointer-events-auto">
            Remove
          </button>
        </div>

        <!-- hidden file input -->
        <input id="photoInput" type="file" name="profile_photo" accept="image/*"
      ...
      <div class="flex-1">
        <div class="mb-4">
          ...
          <input type="text" disabled value="<?= htmlspecialchars($user_name) ?>"
        ...
        <form method="post" class="space-y-3">
          ...
          <div class="flex items-center justify-between mt-4">
            <a href="my-profile.php" class="text-gray-600 hover:underline">← Back</a>
            <button type="submit"
