...
// Fetch trending spots for the week
$trendingWeek = $spotObj->getTrendingWeek(6);

// Fetch all-time trending spots
$trendingAll = $spotObj->getTrendingAll(6);
?>
      ...
      <article 
        ...
        <a href="spot-view.php?id=<?=htmlspecialchars($s['id'])?>" class="flex flex-col h-full">
          ...
          <div class="relative w-full h-96 bg-gray-200 overflow-hidden">
            ...
            <!-- BADGE  -->
            <?php if ($index < 3): ?>
                <div class="trending-badge absolute top-3 left-3 text-white font-bold px-3 py-1 z-10">
                    TOP #<?= $index + 1 ?>
                </div>
                <?php endif; ?>
          ...
          <div class="p-3 flex flex-col justify-between flex-1">
            ...
            <div class="flex items-center justify-between mt-3 text-xs text-gray-400">
              ...
              <span>Likes: <?=intval($s['total_likes'])?> • Comments: <?=intval($s['total_comments'])?></span>
            </div>
          </div>
